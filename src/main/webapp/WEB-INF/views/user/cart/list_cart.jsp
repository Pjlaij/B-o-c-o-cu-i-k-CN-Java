...
<div class="row">
	...
	<a href="<c:url value="checkout"/>" class="shopBtn btn-large pull-right thanhtoan">Thanh toán <span class="icon-arrow-right"></span></a>
...
<content tag="script">
	...
	$(".thanhtoan").on("click",function(){
		alert("Order của bạn đang được xử lý!");
	});
</script>
</content>
</body>