...
-->
	...
	<div class="copyright">
		<div class="container">
			<p class="pull-right">
				<a href="#"><img src="<c:url value="/assets/img/maestro.png"/>"
					alt="payment"></a> <a href="#"><img
					src="<c:url value="/assets/img/mc.png"/>" alt="payment" /></a> <a
					href="#"><img src="<c:url value="/assets/img/pp.png"/>"
					alt="payment" /></a> <a href="#"><img
					src="<c:url value="/assets/img/visa.png"/>" alt="payment" /></a> <a
					href="#"><img src="<c:url value="/assets/img/disc.png"/>"
					alt="payment"></a>
			</p>
			<span>Copyright and copy; 2013<br> bootstrap ecommerce
				shopping template
			</span>
		</div>
	</div>
